    ...
    <header className="bg-white shadow-sm border-b z-50 fixed top-0 left-0 w-full h-[72px]">
      <div className="container mx-auto px-4 py-2 md:py-0 flex justify-between items-center max-w-7xl">
        ...
        <nav className="hidden md:flex gap-6 md:items-center">
          <Link href="/" className="text-gray-700 hover:text-[#003b95] transition">
            Home
          </Link>
          <Link href="/blogs" className="text-gray-700 hover:text-[#003b95] transition">
            Blogs
          </Link>
          <Link href="/rooms" className="text-gray-700 hover:text-[#003b95] transition">
            Rooms
          </Link>
          <Link href="/about" className="text-gray-700 hover:text-[#003b95] transition">
            About
          </Link>
          <Link href="/contact" className="text-gray-700 hover:text-[#003b95] transition">
            Contact
          </Link>
          <button className="bg-[#003b95] text-white px-4 py-2 rounded-md hover:bg-blue-700 transition cursor-pointer">
            <Link className="flex gap-2 items-center" href={'/admin/login'}>
              Login <LogIn size={16} />
            </Link>
          </button>
        </nav>
