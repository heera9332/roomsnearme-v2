...
export default async function Home() {
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Call to Action */}
      <section className="bg-[#003b95] text-white py-12 text-center">
        ...
        <Link href={'/rooms'} className="bg-white text-[#003b95] px-6 py-3 rounded-md font-semibold hover:bg-gray-200 transition">
          Get Started
        </Link>
      </section>
